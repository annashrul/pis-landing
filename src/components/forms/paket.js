...
import {
  ...
  getPayment,
  getAlokasi,
} from "../../redux/actions/bank.action";
        ...
        <TextColumn textOnLeft={false}>
          <TextContent>
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              />
              <ErrorText>
                {errors.channel === undefined ? "" : errors.channel.message}
              </ErrorText>
              ...
              />
              <ErrorText>
                {errors.id_paket === undefined ? "" : errors.id_paket.message}
              </ErrorText>
              <br />
              <HelpText>
                Harga Paket:{" "}
                <b>
                  {toRp(
                    watch("id_paket") ? watch("id_paket").split("|")[1] : 0
                  )}
                </b>
              </HelpText>
              <HelpText>
                Biaya Pendaftaran: <b>{toRp(fee_aktivasi)}</b>
              </HelpText>
              <HelpText>
                Total:{" "}
                <b>
